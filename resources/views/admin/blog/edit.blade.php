            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-small mb-3">
                        <div class="card-body">
                            @csrf
                            <input name="title" class="form-control form-control-lg mb-3" type="text" placeholder="Your Post Title" value="{{$blog->title}}">
                            <textarea class="form-control form-control-lg mb-3" name="description">{{$blog->description}}</textarea>
