                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item p-3">
                            ...
                            <div class="row">
                                ...
                                @if($satisfied)
                                    <div class="col-sm-12">
                                        <form action="{{route('admin.satisfied.update',['id' => $satisfied->id])}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                ...
                                @else
                                    <div class="col-sm-12">
                                        <form action="{{route('admin.satisfied.store')}}" method="post" enctype="multipart/form-data">
                                            @csrf
